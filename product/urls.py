...
from .views import ProductCreatedView, ProductListViewByStore, ProductUpdatedView, ProductDeletedView,ProductListView, ProductOneView
urlpatterns = [
    ...
    path('<int:pk>/show', ProductOneView.as_view(), name='get-one-product' )
]